...
var initialSet = [
	...
	onSuccess = function() { console.log( 'DataStore ready!' ); },
	onFailure = function() { console.log( 'DataStore failed to be created.' ); },

	store = new MemoryStore( initialSet, onSuccess, onFailure );
	*/